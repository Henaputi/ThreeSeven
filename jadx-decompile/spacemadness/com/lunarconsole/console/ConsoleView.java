...
public class ConsoleView extends LinearLayout implements Destroyable, LunarConsoleListener, OnStateChangeListener {
    ...
    class AnonymousClass2 implements OnItemClickListener {
        ...
        class AnonymousClass1 implements Runnable {
            ...
            AnonymousClass1(View view, ConsoleEntry consoleEntry, Context context) {
                this.val$view = view;
        ...
        class AnonymousClass2 implements OnClickListener {
            ...
            AnonymousClass2(String str, ConsoleEntry consoleEntry, String str2) {
        ...
        AnonymousClass2(Console console) {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            ...
            ThreadUtils.runOnUIThread(new AnonymousClass1(view, entry, ctx), 200);
            ...
            String stackTrace = entry.hasStackTrace() ? StackTrace.optimize(entry.stackTrace) : ConsoleView.this.getResources().getString(R.string.lunar_console_log_details_dialog_no_stacktrace_warning);
            messageView.setText(message);
            stacktraceView.setText(stackTrace);
            imageView.setImageDrawable(entry.getIconDrawable(ctx));
            builder.setView(contentView);
            builder.setPositiveButton(R.string.lunar_console_log_details_dialog_button_copy_to_clipboard, new AnonymousClass2(message, entry, stackTrace));
            builder.create().show();
        }
    }
    ...
    public ConsoleView(Context context, Console console) {
        ...
        this.listView.setOnItemClickListener(new AnonymousClass2(console));
