...
public class ConsolePlugin implements Destroyable, Listener, WarningView.Listener {
    ...
    static class AnonymousClass2 implements Runnable {
        ...
        AnonymousClass2(Activity activity, String str, int i, int i2, ConsolePluginImp consolePluginImp) {
    ...
    static {
        entryDispatcher = new ConsoleEntryDispatcher(new OnDispatchListener() {
    ...
    private static void init(Activity activity, String version, int capacity, int trim, ConsolePluginImp pluginImp) {
        ...
        ThreadUtils.runOnUIThread(new AnonymousClass2(activity, version, capacity, trim, pluginImp));
    }
