...
public class NetworkImageView extends ImageView {
    ...
    class AnonymousClass1 implements ImageListener {
        ...
        class AnonymousClass1 implements Runnable {
            ...
            public void run() {
                AnonymousClass1.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new AnonymousClass1(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new AnonymousClass1(isInLayoutPass), maxWidth, maxHeight);
        }
    }
