...
public class MRAIDView extends RelativeLayout {
    ...
    class AnonymousClass6 implements Runnable {
        ...
        public void run() {
            ...
            if (TextUtils.isEmpty(content)) {
                MRAIDLog.i("Could not load part 2 expanded content for URL: " + this.val$finalUrl);
            } else {
                ((Activity) MRAIDView.this.context).runOnUiThread(new AnonymousClass1(content));
            }
        }
    }
    ...
    private WebView createWebView() {
        WebView wv = new AnonymousClass2(this.context);
    ...
    private void close(boolean sendCallback) {
        ...
        this.handler.post(new AnonymousClass4(sendCallback));
    }
    ...
    private void expand(String url) {
        ...
        try {
            ...
            new Thread(new AnonymousClass6(url), "2-part-content").start();
    ...
    private void closeFromExpanded(boolean sendCallback) {
        ...
        this.handler.post(new AnonymousClass8(sendCallback));
    }
    ...
    private void closeFromResized(boolean sendCallback) {
        ...
        removeResizeView();
        addView(this.webView);
        this.handler.post(new AnonymousClass9(sendCallback));
    }
