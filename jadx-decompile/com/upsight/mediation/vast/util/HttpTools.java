...
public class HttpTools {
    ...
    static class AnonymousClass1 extends Thread {
        ...
        AnonymousClass1(String str, String str2, VASTPlayer vASTPlayer) {
            this.val$url = str;
            this.val$type = str2;
        ...
        public void run() {
            ...
            try {
                ...
                FuseLog.v(HttpTools.TAG, "response code:" + code + ", for URL:" + this.val$url);
                ...
                FuseLog.w(HttpTools.TAG, this.val$url + ": " + e2.getMessage() + UpsightEndpoint.SIGNED_MESSAGE_SEPARATOR + e2.toString());
    ...
    public static void httpGetURL(String type, String url, VASTPlayer currentPlayer) {
        if (!TextUtils.isEmpty(url)) {
            new AnonymousClass1(url, type, currentPlayer).start();
        }
    }
}
