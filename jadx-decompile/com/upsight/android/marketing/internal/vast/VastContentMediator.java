...
public final class VastContentMediator extends UpsightContentMediator<VastContentModel> {
    ...
    class AnonymousClass1 implements Listener {
        ...
        AnonymousClass1(MarketingContent marketingContent, VastContentModel vastContentModel) {
    ...
    static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$upsight$android$analytics$UpsightLifeCycleTracker$ActivityState;

        static {
            $SwitchMap$com$upsight$android$analytics$UpsightLifeCycleTracker$ActivityState = new int[ActivityState.values().length];
            try {
    ...
    public View buildContentView(MarketingContent<VastContentModel> content, MarketingContentActionContext actionContext) {
        if (this.mCurrentActivity != null) {
            ...
            if (activity != null) {
                ...
                this.mAdapter.setListener(new AnonymousClass1(content, model));
