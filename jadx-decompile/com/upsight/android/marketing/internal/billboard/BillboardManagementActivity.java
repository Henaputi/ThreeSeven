...
public class BillboardManagementActivity extends Activity {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$upsight$android$marketing$UpsightBillboard$PresentationStyle;

        static {
            $SwitchMap$com$upsight$android$marketing$UpsightBillboard$PresentationStyle = new int[PresentationStyle.values().length];
            try {
    ...
    static {
        STYLE_DIALOG = R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_UpsightDialog;
    }
