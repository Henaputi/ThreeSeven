...
public final class BillboardFragment extends DialogFragment {
    ...
    static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$upsight$android$marketing$UpsightBillboard$Dimensions$LayoutOrientation;

        static {
            $SwitchMap$com$upsight$android$marketing$UpsightBillboard$Dimensions$LayoutOrientation = new int[LayoutOrientation.values().length];
            try {
