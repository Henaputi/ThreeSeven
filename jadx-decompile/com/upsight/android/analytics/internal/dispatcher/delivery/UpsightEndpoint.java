...
class UpsightEndpoint {
    ...
    public Response send(UpsightRequest request) throws IOException {
        ...
        try {
            ...
            this.mLogger.d(Upsight.LOG_TAG, LOG_TEXT_POSTING + refId + LOG_TEXT_TO + this.mEndpointAddress + LOG_TEXT_REQUEST_BODY + this.mRequestLoggingGson.toJson((Object) request), new Object[0]);
