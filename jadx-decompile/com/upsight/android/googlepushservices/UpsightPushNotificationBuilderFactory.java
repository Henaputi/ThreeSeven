...
public interface UpsightPushNotificationBuilderFactory {
    ...
    public static class Default implements UpsightPushNotificationBuilderFactory {
        ...
        class AnonymousClass1 implements OnSubscribe<Bitmap> {
            ...
            class AnonymousClass2 implements ErrorListener {
                final /* synthetic */ Subscriber val$subscriber;
            ...
            public void call(Subscriber<? super Bitmap> subscriber) {
                Default.this.mRequestQueue.add(new ImageRequest(this.val$imageUrl, new AnonymousClass1(subscriber), 0, 0, ScaleType.CENTER_INSIDE, Config.ARGB_8888, new AnonymousClass2(subscriber)).setRetryPolicy(new DefaultRetryPolicy(Default.HTTP_REQUEST_TIMEOUT_MS, Default.HTTP_REQUEST_MAX_RETRIES, Default.HTTP_REQUEST_BACKOFF_MULT)));
            }
        }
        ...
        protected Observable<Bitmap> getImageObservable(String imageUrl) {
            return Observable.create(new AnonymousClass1(imageUrl));
        }
    }
