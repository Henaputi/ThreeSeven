...
public class GooglePushServices implements UpsightGooglePushServicesApi {
    ...
    class AnonymousClass1 implements OnSubscribe<String> {
    ...
    class AnonymousClass5 implements Action1<Config> {
    ...
    private void registerInBackground(String projectId) {
        ...
        Observable.create(new AnonymousClass1(projectId)).subscribeOn(this.mComputationScheduler).observeOn(HandlerScheduler.from(this.mUiThreadHandler)).subscribe(new Observer<String>() {
    ...
    private void registerPushToken(String pushToken) {
        try {
            this.mPushConfigManager.fetchCurrentConfigObservable().subscribeOn(this.mUpsight.getCoreComponent().subscribeOnScheduler()).observeOn(this.mUpsight.getCoreComponent().observeOnScheduler()).subscribe(new AnonymousClass5(pushToken));
        } catch (IOException e) {
