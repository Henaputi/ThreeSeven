...
public final class PushIntentService extends IntentService {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$upsight$android$googlepushservices$internal$PushIntentService$UriTypes;

        static {
            $SwitchMap$com$upsight$android$googlepushservices$internal$PushIntentService$UriTypes = new int[UriTypes.values().length];
            try {
