...
class DataStore implements UpsightDataStore {
    ...
    class AnonymousClass1 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        AnonymousClass1(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass2 implements Action1<Throwable> {
        ...
        AnonymousClass2(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass3 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        AnonymousClass3(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass4 implements Action1<Throwable> {
        ...
        AnonymousClass4(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass5 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        AnonymousClass5(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass6 implements Action1<Throwable> {
        ...
        AnonymousClass6(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass7 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        AnonymousClass7(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass8 implements Action1<Throwable> {
        ...
        AnonymousClass8(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class AnonymousClass9 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        AnonymousClass9(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    public <T> UpsightSubscription fetch(Class<T> clazz, UpsightDataStoreListener<Set<T>> listener) {
        if (clazz == null) {
            ...
            return Subscriptions.from(fetchObservable(clazz).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new AnonymousClass1(listener), new AnonymousClass2(listener)));
        } else {
    ...
    public <T> UpsightSubscription fetch(Class<T> clazz, Set<String> ids, UpsightDataStoreListener<Set<T>> listener) {
        return Subscriptions.from(fetchObservable(clazz, (String[]) ids.toArray(new String[ids.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new AnonymousClass3(listener), new AnonymousClass4(listener)));
    }

    public <T> UpsightSubscription remove(Class<T> clazz, Set<String> ids, UpsightDataStoreListener<Set<T>> listener) {
        return Subscriptions.from(removeObservable(clazz, (String[]) ids.toArray(new String[ids.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new AnonymousClass5(listener), new AnonymousClass6(listener)));
    }
    ...
    public <T> UpsightSubscription store(T object, UpsightDataStoreListener<T> listener) {
        return Subscriptions.from(storeObservable(object).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new AnonymousClass7(listener), new AnonymousClass8(listener)));
    }
    ...
    public <T> UpsightSubscription remove(T object, UpsightDataStoreListener<T> listener) {
        if (listener != null) {
            return Subscriptions.from(removeObservable(object).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new AnonymousClass9(listener), new AnonymousClass10(listener)));
        }
