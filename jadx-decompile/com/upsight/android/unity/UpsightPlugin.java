...
public class UpsightPlugin {
    ...
    public UpsightPlugin() {
        ...
        try {
            ...
            UnityBridge.runSafelyOnUiThread(new AnonymousClass1(activity));
        } catch (Exception e) {
    ...
    public void setLocation(double lat, double lon) {
        UnityBridge.runSafelyOnUiThread(new AnonymousClass2(lat, lon));
    }
    ...
    public void setUserAttributesString(@NonNull String key, @NonNull String value) {
        UnityBridge.runSafelyOnUiThread(new AnonymousClass4(key, value));
    }

    public void setUserAttributesFloat(@NonNull String key, float value) {
        UnityBridge.runSafelyOnUiThread(new AnonymousClass5(key, value));
    }

    public void setUserAttributesInt(@NonNull String key, int value) {
        UnityBridge.runSafelyOnUiThread(new AnonymousClass6(key, value));
    }

    public void setUserAttributesBool(@NonNull String key, boolean value) {
        UnityBridge.runSafelyOnUiThread(new AnonymousClass7(key, value));
    }

    public void setUserAttributesDatetime(@NonNull String key, long value) {
        UnityBridge.runSafelyOnUiThread(new AnonymousClass8(value, key));
    }
    ...
    public void recordAnalyticsEvent(@NonNull String eventName, @NonNull String properties) {
        UnityBridge.runSafelyOnUiThread(new AnonymousClass9(eventName, properties));
    }
