...
final class ReflectionHelper {
    ...
    static class AnonymousClass1 implements InvocationHandler {
        ...
        AnonymousClass1(int i, Class[] clsArr) {
            this.a = i;
            this.b = clsArr;
        }
    ...
    static {
        LOG = false;
        a = new a[AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD];
    }
    ...
    protected static Object newProxyInstance(int i, Class[] clsArr) {
        return Proxy.newProxyInstance(ReflectionHelper.class.getClassLoader(), clsArr, new AnonymousClass1(i, clsArr));
    }
}
