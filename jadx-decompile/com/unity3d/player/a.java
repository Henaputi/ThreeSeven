...
final class a {
    ...
    class AnonymousClass1 implements PreviewCallback {
        long a;
        final /* synthetic */ a b;
        final /* synthetic */ a c;
    ...
    private void b(a aVar) {
        synchronized (this.g) {
            ...
            PreviewCallback anonymousClass1 = new AnonymousClass1(this, aVar);
            int i = (((this.c.width * this.c.height) * this.d) / 8) + AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD;
    ...
    private final int[] e() {
        double d = (double) (this.k * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE);
        List supportedPreviewFpsRange = this.b.getSupportedPreviewFpsRange();
        if (supportedPreviewFpsRange == null) {
            supportedPreviewFpsRange = new ArrayList();
        }
        int[] iArr = new int[]{this.k * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE, this.k * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE};
