...
public class UiActivity extends Activity {
    ...
    class AnonymousClass2 implements OnClickListener {
        ...
        AnonymousClass2(String[] strArr, int i, String str) {
    ...
    class AnonymousClass3 implements OnClickListener {
        ...
        AnonymousClass3(EditText editText, String[] strArr, int i) {
    ...
    class AnonymousClass4 implements OnClickListener {
        ...
        AnonymousClass4(String[] strArr, int i, EditText editText, EditText editText2) {
    ...
    private void showAlertDialog(Bundle bundle) {
        ...
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, buttonsList[eachButtonIndex], new AnonymousClass2(tempButtonList, eachButtonIndex, tag));
        }
    ...
    private void showSinglePrompt(Bundle bundle) {
        ...
        String[] tempButtonList = buttonsList;
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, buttonsList[eachButtonIndex], new AnonymousClass3(promptField, tempButtonList, eachButtonIndex));
        }
        this.alertDialog.show();
    }
    ...
    private void showLoginPrompt(Bundle bundle) {
        ...
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, finalButtonList[eachButtonIndex], new AnonymousClass4(finalButtonList, eachButtonIndex, usernameField, passwordField));
        }
        this.alertDialog.show();
    }
