...
public class SfidaPeripheral extends Peripheral {
    ...
    class AnonymousClass7 implements Runnable {
        ...
        AnonymousClass7(boolean z, BluetoothError bluetoothError) {
    ...
    public SfidaPeripheral(HandlerExecutor serialExecutor, Context context, BluetoothDevice bluetoothDevice, byte[] scanRecord) {
        ...
        this.bluetoothGattCallback = new BluetoothGattCallback() {
            ...
            class AnonymousClass1 implements Runnable {
                ...
                AnonymousClass1(BluetoothGatt bluetoothGatt, int i, int i2) {
            ...
            class AnonymousClass2 implements Runnable {
                ...
                AnonymousClass2(BluetoothGatt bluetoothGatt, int i) {
                    this.val$gatt = bluetoothGatt;
                    this.val$status = i;
                }
            ...
            class AnonymousClass3 implements Runnable {
                ...
                AnonymousClass3(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, int i) {
                    this.val$gatt = bluetoothGatt;
            ...
            class AnonymousClass4 implements Runnable {
                ...
                AnonymousClass4(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, int i) {
                    this.val$gatt = bluetoothGatt;
                    this.val$characteristic = bluetoothGattCharacteristic;
                    this.val$status = i;
                }
            ...
            class AnonymousClass5 implements Runnable {
                ...
                AnonymousClass5(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
                    this.val$gatt = bluetoothGatt;
                    this.val$characteristic = bluetoothGattCharacteristic;
                }
            ...
            class AnonymousClass6 implements Runnable {
                ...
                AnonymousClass6(BluetoothGatt bluetoothGatt, BluetoothGattDescriptor bluetoothGattDescriptor, int i) {
                    this.val$gatt = bluetoothGatt;
            ...
            public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
                Log.d(SfidaPeripheral.TAG, "onConnectionStateChange");
                SfidaPeripheral.this.serialExecutor.execute(new AnonymousClass1(gatt, status, newState));
            }

            public void onServicesDiscovered(BluetoothGatt gatt, int status) {
                Log.d(SfidaPeripheral.TAG, "onServicesDiscovered");
                SfidaPeripheral.this.serialExecutor.execute(new AnonymousClass2(gatt, status));
            }

            public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
                Log.d(SfidaPeripheral.TAG, "onCharacteristicRead");
                SfidaPeripheral.this.serialExecutor.execute(new AnonymousClass3(gatt, characteristic, status));
            }

            public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
                Log.d(SfidaPeripheral.TAG, "onCharacteristicWrite");
                SfidaPeripheral.this.serialExecutor.execute(new AnonymousClass4(gatt, characteristic, status));
            }

            public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
                Log.d(SfidaPeripheral.TAG, "onCharacteristicChanged");
                SfidaPeripheral.this.serialExecutor.execute(new AnonymousClass5(gatt, characteristic));
            }

            public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
                Log.d(SfidaPeripheral.TAG, "onDescriptorWrite");
                SfidaPeripheral.this.serialExecutor.execute(new AnonymousClass6(gatt, descriptor, status));
            }
            ...
            public void run() {
                SfidaPeripheral.this.discoverServices(new CompletionCallback() {
                    ...
                    public void onCompletion(boolean success, BluetoothError error) {
                        SfidaPeripheral.this.serialExecutor.execute(new AnonymousClass1(success, error));
                    }
                });
            }
        });
    ...
    private void callMonitorDisconnectCallback(boolean isDisconnected, BluetoothError err) {
        this.serialExecutor.execute(new AnonymousClass7(isDisconnected, err));
    }
