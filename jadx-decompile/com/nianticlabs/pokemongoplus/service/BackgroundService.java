...
public class BackgroundService extends Service {
    ...
    static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BridgeConstants$SfidaState = new int[SfidaState.values().length];
            try {
            ...
            $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action = new int[Action.values().length];
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.SEND_NOTIFICATION_ACTION.ordinal()] = BackgroundService.kCapturedPokemon;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.STOP_NOTIFICATION_ACTION.ordinal()] = BackgroundService.kPokemonEscaped;
            } catch (NoSuchFieldError e6) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.BATTERY_LEVEL_ACTION.ordinal()] = BackgroundService.kRetrievedOneItem;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.SFIDA_STATE_ACTION.ordinal()] = BackgroundService.kRetrievedItems;
            } catch (NoSuchFieldError e8) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.PLUGIN_STATE_ACTION.ordinal()] = BackgroundService.kPokestopOutOfRange;
    ...
    public void onCreate() {
        ...
        this.messenger = new Messenger(new Handler() {
            public void handleMessage(Message message) {
                ...
                ClientBridgeMessage.Action action = bridgeMessage.getAction();
    ...
    private void createNewStylePlayerNotification(String message) {
        ...
        finishPlayerNotificationCreation(new Builder(this).setSmallIcon(R.drawable.ic_pgp_white).setContentTitle(getResources().getString(R.string.Pokemon_Go_Plus)).setContentText(message).setPriority(kPokemonEscaped).setVisibility(kCapturedPokemon).addAction(new NotificationCompat.Action.Builder(R.drawable.ic_close_black_24dp, getResources().getString(R.string.Stop_button_label), createStopSelfPendingIntent()).build()));
    }
    ...
    private void createOldStylePlayerNotification(String message) {
        ...
        Builder builder = new Builder(this).setSmallIcon(R.drawable.ic_pgp_white).setPriority(kPokemonEscaped).setVisibility(kCapturedPokemon);
        this.contentView = new RemoteViews(getPackageName(), R.layout.pgp_status_notif);
        this.contentView.setOnClickPendingIntent(R.id.stopPgp, pendingStopSelf);
        this.contentView.setTextViewText(R.id.pgpStatusTitle, getResources().getString(R.string.Pokemon_Go_Plus));
        this.contentView.setTextViewText(R.id.pgpStatusDetail, message);
    ...
    public void onHandleBackgroundMessage(BackgroundBridgeMessage message) {
        switch (AnonymousClass3.$SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[message.getAction().ordinal()]) {
    ...
    private void updateNotificationForSfidaState(SfidaState newSfidaState, SfidaState sfidaState) {
        ...
        if (newSfidaState != sfidaState) {
            switch (AnonymousClass3.$SwitchMap$com$nianticlabs$pokemongoplus$bridge$BridgeConstants$SfidaState[newSfidaState.ordinal()]) {
                case kPokemonEscaped /*2*/:
