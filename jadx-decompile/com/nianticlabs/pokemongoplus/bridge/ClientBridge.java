...
public class ClientBridge implements ServiceConnection {
    ...
    static class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(ClientBridgeMessage clientBridgeMessage) {
    ...
    static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.UPDATE_TIMESTAMP_ACTION.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.SFIDA_STATE_ACTION.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.ENCOUNTER_ID_ACTION.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.POKESTOP_ACTION.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.CENTRAL_STATE_ACTION.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.SCANNED_SFIDA_ACTION.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.PLUGIN_STATE_ACTION.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.IS_SCANNING_ACTION.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.BATTERY_LEVEL_ACTION.ordinal()] = 9;
            } catch (NoSuchFieldError e9) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.CONFIRM_BRIDGE_SHUTDOWN_ACTION.ordinal()] = 10;
            } catch (NoSuchFieldError e10) {
            }
            try {
                $SwitchMap$com$nianticlabs$pokemongoplus$bridge$BackgroundBridgeMessage$Action[Action.SEND_NOTIFICATION_ACTION.ordinal()] = 11;
