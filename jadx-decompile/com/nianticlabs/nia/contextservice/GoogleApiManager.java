...
public class GoogleApiManager {
    ...
    static /* synthetic */ class AnonymousClass3 {
        static final /* synthetic */ int[] $SwitchMap$com$nianticlabs$nia$contextservice$GoogleApiManager$AppState;
        static final /* synthetic */ int[] $SwitchMap$com$nianticlabs$nia$contextservice$GoogleApiManager$State;

        static {
            $SwitchMap$com$nianticlabs$nia$contextservice$GoogleApiManager$AppState = new int[AppState.values().length];
            try {
