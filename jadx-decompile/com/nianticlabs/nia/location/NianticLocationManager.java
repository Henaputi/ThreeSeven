...
public class NianticLocationManager extends ContextService {
    ...
    class AnonymousClass1 implements GpsProviderListener {
    ...
    class AnonymousClass2 implements ProviderListener {
        final /* synthetic */ String val$name;
    ...
    class AnonymousClass3 implements Runnable {
        ...
        AnonymousClass3(int i, double d, int i2) {
    ...
    private void addProvider(String name, Provider provider) {
        ...
        if (provider instanceof GpsProvider) {
            provider.setListener(new AnonymousClass1(name));
        } else {
            provider.setListener(new AnonymousClass2(name));
        }
    }
    ...
    public void configureLocationParameters(double update_distance, int gps_update_time_ms, int net_update_time_ms) {
        ContextService.runOnServiceHandler(new AnonymousClass3(gps_update_time_ms, update_distance, net_update_time_ms));
    }
