...
public class AccountsActivity extends Activity {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        AnonymousClass2(UserRecoverableAuthException userRecoverableAuthException) {
    ...
    private void getAuth(String accountName) {
        new AnonymousClass1(accountName).execute(new Void[0]);
    }
    ...
    private static void getAuthTokenBlocking(AccountsActivity activity, String accountName) {
        try {
            ...
            String token = GoogleAuthUtil.getToken((Context) activity, accountName, scope);
    ...
    private void askUserToRecover(UserRecoverableAuthException e) {
        runOnUiThread(new AnonymousClass2(e));
    }
