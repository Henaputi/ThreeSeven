...
public class GoogleInAppBillingProvider implements InAppBillingProvider {
    ...
    private class ProcessPurchasedItemsTask extends AsyncTask<Void, Void, Bundle> {
        ...
        L_0x0006:
            ...
            r2 = 0;
        L_0x0009:
            r8 = r12.billingService;	 Catch:{ RemoteException -> 0x0073 }
            r9 = 3;
            r10 = com.nianticlabs.nia.iap.GoogleInAppBillingProvider.this;	 Catch:{ RemoteException -> 0x0073 }
            r10 = r10.packageName;	 Catch:{ RemoteException -> 0x0073 }
            r11 = "inapp";
            r3 = r8.getPurchases(r9, r10, r11, r2);	 Catch:{ RemoteException -> 0x0073 }
            r5 = com.nianticlabs.nia.iap.GoogleInAppBillingProvider.getResponseCodeFromBundle(r3);	 Catch:{ RemoteException -> 0x0073 }
            r8 = "INAPP_PURCHASE_DATA_LIST";
            r4 = r3.getStringArrayList(r8);	 Catch:{ RemoteException -> 0x0073 }
            r8 = "INAPP_DATA_SIGNATURE_LIST";
            r7 = r3.getStringArrayList(r8);	 Catch:{ RemoteException -> 0x0073 }
            r8 = 5;
        ...
        L_0x003f:
            r8 = "INAPP_PURCHASE_DATA_LIST";
            r8 = r3.containsKey(r8);	 Catch:{ RemoteException -> 0x0073 }
        ...
        L_0x0047:
            ...
            if (r8 == 0) goto L_0x002b;
        L_0x004f:
            r8 = r4.size();	 Catch:{ RemoteException -> 0x0073 }
            r9 = r7.size();	 Catch:{ RemoteException -> 0x0073 }
        ...
        L_0x005d:
            ...
            r2 = r3.getString(r8);	 Catch:{ RemoteException -> 0x0073 }
            if (r2 == 0) goto L_0x002b;
        L_0x0065:
            r8 = r2.length();	 Catch:{ RemoteException -> 0x0073 }
            if (r8 != 0) goto L_0x0009;
        L_0x006b:
            goto L_0x002b;
        L_0x006c:
            r0.addAll(r4);	 Catch:{ RemoteException -> 0x0073 }
            r1.addAll(r7);	 Catch:{ RemoteException -> 0x0073 }
            goto L_0x005d;
        L_0x0073:
            r8 = move-exception;
            goto L_0x002b;
        ...
        protected void onPostExecute(Bundle result) {
            if (result != null) {
                ContextService.runOnServiceHandler(new AnonymousClass1(result));
                return;
            }
            GoogleInAppBillingProvider.this.finalizeConnectionResult();
            GoogleInAppBillingProvider.this.maybeDisconnectBillingService();
        ...
        if (!this.connectionInProgress) {
            ...
            this.serviceConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    ContextService.runOnServiceHandler(new AnonymousClass1(service));
                }
    ...
    public void forwardedOnActivityResult(int resultCode, Intent data) {
        ...
        ContextService.runOnServiceHandler(new AnonymousClass3(resultCode, responseCode, purchaseData, dataSignature));
    }
