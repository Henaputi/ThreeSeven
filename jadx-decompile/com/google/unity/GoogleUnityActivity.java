...
public class GoogleUnityActivity extends Activity {
    ...
    class AnonymousClass5 implements OnSystemUiVisibilityChangeListener {
        ...
        public void onSystemUiVisibilityChange(int visibility) {
            if ((visibility & 2) == 0) {
                this.val$handler.postDelayed(new Runnable() {
                    public void run() {
    ...
    public void showAndroidViewLayer(int layoutResId) {
        runOnUiThread(new AnonymousClass4(this, layoutResId));
    }
    ...
    private void startImmersiveMode() {
        getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new AnonymousClass5(new Handler()));
    }
