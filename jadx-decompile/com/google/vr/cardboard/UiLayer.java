...
public class UiLayer {
    ...
    public void attachUiLayer(ViewGroup parentView) {
        ((Activity) this.context).runOnUiThread(new AnonymousClass3(parentView));
    }

    public void setEnabled(boolean enabled) {
        ((Activity) this.context).runOnUiThread(new AnonymousClass4(enabled));
    }

    public void setSettingsButtonEnabled(boolean enabled) {
        this.isSettingsButtonEnabled = enabled;
        ((Activity) this.context).runOnUiThread(new AnonymousClass5(enabled));
    }

    public void setBackButtonListener(Runnable runnable) {
        this.backButtonRunnable = runnable;
        ((Activity) this.context).runOnUiThread(new AnonymousClass6(runnable));
    }

    public void setAlignmentMarkerEnabled(boolean enabled) {
        this.isAlignmentMarkerEnabled = enabled;
        ((Activity) this.context).runOnUiThread(new AnonymousClass7(enabled));
    }
