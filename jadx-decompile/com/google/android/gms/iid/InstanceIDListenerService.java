...
public class InstanceIDListenerService extends Service {
    ...
    class AnonymousClass1 extends Handler {
        ...
        AnonymousClass1(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    public InstanceIDListenerService() {
        this.zzaDD = new MessengerCompat(new AnonymousClass1(this, Looper.getMainLooper()));
        this.zzaDE = new BroadcastReceiver() {
            final /* synthetic */ InstanceIDListenerService zzaDJ;
