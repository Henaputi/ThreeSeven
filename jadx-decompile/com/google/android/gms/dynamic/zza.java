...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class AnonymousClass2 implements zza {
        ...
        AnonymousClass2(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
    ...
    class AnonymousClass3 implements zza {
        ...
        AnonymousClass3(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
            this.zzapu = bundle;
        }
    ...
    class AnonymousClass4 implements zza {
        ...
        AnonymousClass4(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
    ...
    public void onCreate(Bundle savedInstanceState) {
        zza(savedInstanceState, new AnonymousClass3(this, savedInstanceState));
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FrameLayout frameLayout = new FrameLayout(inflater.getContext());
        zza(savedInstanceState, new AnonymousClass4(this, frameLayout, inflater, container, savedInstanceState));
        if (this.zzapn == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle attrs, Bundle savedInstanceState) {
        zza(savedInstanceState, new AnonymousClass2(this, activity, attrs, savedInstanceState));
    }
