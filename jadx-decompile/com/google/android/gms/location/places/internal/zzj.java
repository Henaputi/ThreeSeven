...
public class zzj implements PlaceDetectionApi {
    ...
    class AnonymousClass1 extends zzd<zzk> {
        final /* synthetic */ PlaceFilter zzaHf;
        final /* synthetic */ zzj zzaHg;

        AnonymousClass1(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceFilter placeFilter) {
    ...
    class AnonymousClass2 extends zzf<zzk> {
        final /* synthetic */ zzj zzaHg;
        final /* synthetic */ PlaceReport zzaHh;

        AnonymousClass2(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceReport placeReport) {
            this.zzaHg = com_google_android_gms_location_places_internal_zzj;
    ...
    public PendingResult<PlaceLikelihoodBuffer> getCurrentPlace(GoogleApiClient client, PlaceFilter filter) {
        return client.zza(new AnonymousClass1(this, Places.zzaGA, client, filter));
    }

    public PendingResult<Status> reportDeviceAtPlace(GoogleApiClient client, PlaceReport report) {
        return client.zzb(new AnonymousClass2(this, Places.zzaGA, client, report));
    }
}
