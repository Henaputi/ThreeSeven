...
public class zza implements ActivityRecognitionApi {
    ...
    class AnonymousClass1 extends zza {
        ...
        AnonymousClass1(zza com_google_android_gms_location_internal_zza, GoogleApiClient googleApiClient, long j, PendingIntent pendingIntent) {
    ...
    class AnonymousClass2 extends zza {
        ...
        AnonymousClass2(zza com_google_android_gms_location_internal_zza, GoogleApiClient googleApiClient, PendingIntent pendingIntent) {
            this.zzaEZ = com_google_android_gms_location_internal_zza;
            this.zzaEY = pendingIntent;
            super(googleApiClient);
        }
    ...
    public PendingResult<Status> removeActivityUpdates(GoogleApiClient client, PendingIntent callbackIntent) {
        return client.zzb(new AnonymousClass2(this, client, callbackIntent));
    }
    ...
    public PendingResult<Status> requestActivityUpdates(GoogleApiClient client, long detectionIntervalMillis, PendingIntent callbackIntent) {
        return client.zzb(new AnonymousClass1(this, client, detectionIntervalMillis, callbackIntent));
    }
}
