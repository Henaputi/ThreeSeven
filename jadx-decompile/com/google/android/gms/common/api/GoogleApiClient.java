...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        class AnonymousClass1 implements Runnable {
            ...
            AnonymousClass1(Builder builder, GoogleApiClient googleApiClient) {
                this.zzaaU = builder;
        ...
        private GoogleApiClient zznC() {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new AnonymousClass1(this, com_google_android_gms_internal_zzli));
            } else {
