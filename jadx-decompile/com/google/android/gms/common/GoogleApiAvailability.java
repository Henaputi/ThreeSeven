...
public class GoogleApiAvailability {
    ...
    public Dialog zza(Activity activity, OnCancelListener onCancelListener) {
        ...
        builder.setMessage(activity.getResources().getString(R.string.common_google_play_services_updating_text, new Object[]{zzaf}));
    ...
    public Intent zza(Context context, int i, String str) {
        switch (i) {
            ...
            case spacemadness.com.lunarconsole.R.styleable.LoadingImageView_circleCrop /*2*/:
