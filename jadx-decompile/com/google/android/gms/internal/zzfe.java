...
public class zzfe extends zzfh {
    ...
    class AnonymousClass1 implements OnClickListener {
        ...
        AnonymousClass1(zzfe com_google_android_gms_internal_zzfe, String str, String str2) {
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzp.zzbv().zzaB(zzaj)) {
                    ...
                    zzK.setTitle(zzp.zzby().zzd(R.string.store_picture_title, "Save image"));
                    zzK.setMessage(zzp.zzby().zzd(R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzK.setPositiveButton(zzp.zzby().zzd(R.string.accept, "Accept"), new AnonymousClass1(this, str, zzaj));
                    zzK.setNegativeButton(zzp.zzby().zzd(R.string.decline, "Decline"), new OnClickListener() {
                        final /* synthetic */ zzfe zzAu;
