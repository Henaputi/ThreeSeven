...
public final class zzli extends GoogleApiClient {
    ...
    class AnonymousClass4 implements OnConnectionFailedListener {
        ...
        AnonymousClass4(zzli com_google_android_gms_internal_zzli, Api api, int i) {
    ...
    class AnonymousClass5 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ AtomicReference zzacu;
        final /* synthetic */ zzlo zzacv;

        AnonymousClass5(zzli com_google_android_gms_internal_zzli, AtomicReference atomicReference, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    class AnonymousClass6 implements OnConnectionFailedListener {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ zzlo zzacv;

        AnonymousClass6(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
        }
    ...
    class AnonymousClass7 implements ResultCallback<Status> {
        ...
        AnonymousClass7(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo, boolean z, GoogleApiClient googleApiClient) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
            this.zzacw = z;
    ...
    class AnonymousClass8 implements Runnable {
        ...
        AnonymousClass8(zzli com_google_android_gms_internal_zzli, FragmentActivity fragmentActivity) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    public zzli(Context context, Looper looper, com.google.android.gms.common.internal.zzf com_google_android_gms_common_internal_zzf, GoogleApiAvailability googleApiAvailability, com.google.android.gms.common.api.Api.zza<? extends zzqw, zzqx> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzqw__com_google_android_gms_internal_zzqx, Map<Api<?>, ApiOptions> map, ArrayList<ConnectionCallbacks> arrayList, ArrayList<OnConnectionFailedListener> arrayList2, int i) {
        ...
        this.zzacq = new com.google.android.gms.common.internal.zzk.zza() {
            final /* synthetic */ zzli zzacr;
    ...
    private OnConnectionFailedListener zza(Api<?> api, int i) {
        return new AnonymousClass4(this, api, i);
    }
    ...
    private void zza(GoogleApiClient googleApiClient, zzlo com_google_android_gms_internal_zzlo, boolean z) {
        zzlx.zzagw.zzb(googleApiClient).setResultCallback(new AnonymousClass7(this, com_google_android_gms_internal_zzlo, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzacg.containsKey(zzlx.zzRk)) {
            ...
            ConnectionCallbacks anonymousClass5 = new AnonymousClass5(this, atomicReference, com_google_android_gms_internal_zzlo);
            GoogleApiClient build = new Builder(this.mContext).addApi(zzlx.API).addConnectionCallbacks(anonymousClass5).addOnConnectionFailedListener(new AnonymousClass6(this, com_google_android_gms_internal_zzlo)).setHandler(this.zzace).build();
    ...
    public void stopAutoManage(FragmentActivity lifecycleActivity) {
        if (this.zzaaM >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new AnonymousClass8(this, lifecycleActivity));
                return;
            } else {
                zza.zzbp(this.zzaaM);
                return;
