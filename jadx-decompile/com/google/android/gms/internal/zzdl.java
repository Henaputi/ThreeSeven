...
public class zzdl implements zzdk {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        class AnonymousClass1 implements Runnable {
            ...
            final /* synthetic */ AnonymousClass1 zzxE;

            AnonymousClass1(AnonymousClass1 anonymousClass1, JSONObject jSONObject) {
                this.zzxE = anonymousClass1;
        ...
        AnonymousClass1(zzdl com_google_android_gms_internal_zzdl, Map map, zziz com_google_android_gms_internal_zziz) {
        ...
        public void run() {
            ...
            if (zzX == null) {
                ...
                zzid.zzIE.post(new AnonymousClass1(this, zzX));
            }
        }
    }
    ...
    public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
        zzic.zza(new AnonymousClass1(this, map, com_google_android_gms_internal_zziz));
    }
