...
public class zzfb extends zzfh {
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzK.setTitle(zzp.zzby().zzd(R.string.create_calendar_title, "Create calendar event"));
            zzK.setMessage(zzp.zzby().zzd(R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzK.setPositiveButton(zzp.zzby().zzd(R.string.accept, "Accept"), new OnClickListener() {
