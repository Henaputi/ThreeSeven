...
public class zzgm implements Callable<zzhs> {
    ...
    class AnonymousClass1 implements zzdk {
        final /* synthetic */ zzbb zzDK;
        final /* synthetic */ zzb zzDL;
        final /* synthetic */ zzin zzDM;
        final /* synthetic */ zzgm zzDN;

        AnonymousClass1(zzgm com_google_android_gms_internal_zzgm, zzbb com_google_android_gms_internal_zzbb, zzb com_google_android_gms_internal_zzgm_zzb, zzin com_google_android_gms_internal_zzin) {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        AnonymousClass2(zzgm com_google_android_gms_internal_zzgm, zzin com_google_android_gms_internal_zzin, String str) {
            this.zzDN = com_google_android_gms_internal_zzgm;
    ...
    class AnonymousClass3 implements zzdk {
        ...
        AnonymousClass3(zzgm com_google_android_gms_internal_zzgm, zzf com_google_android_gms_ads_internal_formats_zzf) {
            this.zzDN = com_google_android_gms_internal_zzgm;
    ...
    class AnonymousClass4 implements com.google.android.gms.internal.zzip.zza<List<zzc>, com.google.android.gms.ads.internal.formats.zza> {
        final /* synthetic */ zzgm zzDN;
        ...
        AnonymousClass4(zzgm com_google_android_gms_internal_zzgm, String str, Integer num, Integer num2, int i, int i2, int i3) {
            this.zzDN = com_google_android_gms_internal_zzgm;
            this.zzDR = str;
            this.zzDS = num;
            this.zzDT = num2;
    ...
    class AnonymousClass5 implements com.google.android.gms.internal.zzih.zza<zzc> {
        final /* synthetic */ String zzAs;
        final /* synthetic */ zzgm zzDN;
        final /* synthetic */ boolean zzDX;
        final /* synthetic */ double zzDY;

        AnonymousClass5(zzgm com_google_android_gms_internal_zzgm, boolean z, double d, String str) {
            this.zzDN = com_google_android_gms_internal_zzgm;
            this.zzDX = z;
            this.zzDY = d;
            this.zzAs = str;
    ...
    private zziq<zzc> zza(JSONObject jSONObject, boolean z, boolean z2) throws JSONException {
        ...
        if (!TextUtils.isEmpty(string)) {
            return z2 ? new zzio(new zzc(null, Uri.parse(string), optDouble)) : this.zzDF.zza(string, new AnonymousClass5(this, z, optDouble, string));
        } else {
            zza(0, z);
    ...
    private void zza(com.google.android.gms.ads.internal.formats.zzh.zza com_google_android_gms_ads_internal_formats_zzh_zza, zzbb com_google_android_gms_internal_zzbb) {
        if (com_google_android_gms_ads_internal_formats_zzh_zza instanceof zzf) {
            ...
            zzdk anonymousClass3 = new AnonymousClass3(this, com_google_android_gms_ads_internal_formats_zzf);
            com_google_android_gms_internal_zzgm_zzb.zzDZ = anonymousClass3;
            com_google_android_gms_internal_zzbb.zza("/nativeAdCustomClick", anonymousClass3);
        }
    }
    ...
    private JSONObject zzb(zzbb com_google_android_gms_internal_zzbb) throws TimeoutException, JSONException {
        ...
        zzb com_google_android_gms_internal_zzgm_zzb = new zzb(this);
        zzdk anonymousClass1 = new AnonymousClass1(this, com_google_android_gms_internal_zzbb, com_google_android_gms_internal_zzgm_zzb, com_google_android_gms_internal_zzin);
        com_google_android_gms_internal_zzgm_zzb.zzDZ = anonymousClass1;
        com_google_android_gms_internal_zzbb.zza("/nativeAdPreProcess", anonymousClass1);
    ...
    protected zza zzd(JSONObject jSONObject) throws JSONException, TimeoutException {
        ...
        if ("3".equals(string)) {
            ...
            zzin com_google_android_gms_internal_zzin = new zzin();
            zzid.zzIE.post(new AnonymousClass2(this, com_google_android_gms_internal_zzin, string2));
    ...
    public zziq<com.google.android.gms.ads.internal.formats.zza> zze(JSONObject jSONObject) throws JSONException {
        ...
        return zzip.zza(zzip.zzh(arrayList), new AnonymousClass4(this, optString, zzb2, zzb, optInt, optInt3, optInt2));
    }
