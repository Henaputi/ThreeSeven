...
public class zzhi extends zzhz implements zzhj, zzhm {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(zzhi com_google_android_gms_internal_zzhi, zzen com_google_android_gms_internal_zzen, AdRequestParcel adRequestParcel) {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        AnonymousClass2(zzhi com_google_android_gms_internal_zzhi, zzen com_google_android_gms_internal_zzen, AdRequestParcel adRequestParcel, zzhl com_google_android_gms_internal_zzhl) {
            this.zzHl = com_google_android_gms_internal_zzhi;
            this.zzHk = com_google_android_gms_internal_zzen;
            this.zzpe = adRequestParcel;
        ...
        if (this.zzHg != null && this.zzHg.zzgd() != null && this.zzHg.zzgc() != null) {
            ...
            try {
                if (zzgc.isInitialized()) {
                    com.google.android.gms.ads.internal.util.client.zza.zzJt.post(new AnonymousClass1(this, zzgc, adRequestParcel));
                } else {
                    com.google.android.gms.ads.internal.util.client.zza.zzJt.post(new AnonymousClass2(this, zzgc, adRequestParcel, zzgd));
                }
            } catch (Throwable e) {
