...
public class zzlg implements zzlj {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzb {
        ...
        class AnonymousClass1 extends zzb {
            ...
            AnonymousClass1(zza com_google_android_gms_internal_zzlg_zza, zzlj com_google_android_gms_internal_zzlj, zzlg com_google_android_gms_internal_zzlg, ConnectionResult connectionResult) {
        ...
        public void zza(ConnectionResult connectionResult, AuthAccountResult authAccountResult) {
            ...
            if (com_google_android_gms_internal_zzlg != null) {
                com_google_android_gms_internal_zzlg.zzabr.zza(new AnonymousClass1(this, com_google_android_gms_internal_zzlg, com_google_android_gms_internal_zzlg, connectionResult));
            }
        }
    }
    ...
    private static class zzb extends com.google.android.gms.common.internal.zzt.zza {
        ...
        class AnonymousClass1 extends zzb {
            ...
            AnonymousClass1(zzb com_google_android_gms_internal_zzlg_zzb, zzlj com_google_android_gms_internal_zzlj, zzlg com_google_android_gms_internal_zzlg, ResolveAccountResponse resolveAccountResponse) {
        ...
        public void zzb(ResolveAccountResponse resolveAccountResponse) {
            zzlg com_google_android_gms_internal_zzlg = (zzlg) this.zzabM.get();
            if (com_google_android_gms_internal_zzlg != null) {
                com_google_android_gms_internal_zzlg.zzabr.zza(new AnonymousClass1(this, com_google_android_gms_internal_zzlg, com_google_android_gms_internal_zzlg, resolveAccountResponse));
            }
        }
    }
    ...
    private class zze extends zzi {
        ...
        class AnonymousClass1 extends zzb {
            ...
            AnonymousClass1(zze com_google_android_gms_internal_zzlg_zze, zzlj com_google_android_gms_internal_zzlj, ConnectionResult connectionResult) {
        ...
        public void zznO() {
            ...
            if (isGooglePlayServicesAvailable != 0) {
                this.zzabL.zzabr.zza(new AnonymousClass1(this, this.zzabL, new ConnectionResult(isGooglePlayServicesAvailable, null)));
                return;
            }
            if (this.zzabL.zzabD) {
