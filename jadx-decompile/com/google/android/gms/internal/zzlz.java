...
public final class zzlz implements zzly {
    ...
    class AnonymousClass1 extends zza {
        ...
        AnonymousClass1(zzlz com_google_android_gms_internal_zzlz, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzb(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new AnonymousClass1(this, googleApiClient));
    }
}
