...
public abstract class GcmListenerService extends Service {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class AnonymousClass2 extends AsyncTask<Void, Void, Void> {
        ...
        AnonymousClass2(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaCg = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new AnonymousClass1(this, intent));
        } else {
            new AnonymousClass2(this, intent).execute(new Void[0]);
        }
        return 3;
    }
