...
public final class LargeParcelTeleporter implements SafeParcelable {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(LargeParcelTeleporter largeParcelTeleporter, OutputStream outputStream, byte[] bArr) {
    ...
    protected <T> ParcelFileDescriptor zzf(byte[] bArr) {
        ...
        try {
            ...
            try {
                new Thread(new AnonymousClass1(this, autoCloseOutputStream, bArr)).start();
                return createPipe[0];
            } catch (IOException e2) {
                e = e2;
            }
