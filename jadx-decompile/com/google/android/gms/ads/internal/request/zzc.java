...
public final class zzc {
    ...
    static class AnonymousClass1 implements zzb {
    ...
    public static zzhz zza(Context context, AdRequestInfoParcel adRequestInfoParcel, zza com_google_android_gms_ads_internal_request_zzc_zza) {
        return zza(context, adRequestInfoParcel, com_google_android_gms_ads_internal_request_zzc_zza, new AnonymousClass1(context));
    }
