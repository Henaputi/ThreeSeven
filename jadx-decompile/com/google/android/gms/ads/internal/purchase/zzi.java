...
public class zzi {
    ...
    class AnonymousClass1 implements ServiceConnection {
        ...
        AnonymousClass1(zzi com_google_android_gms_ads_internal_purchase_zzi, Context context) {
    ...
    public void zzx(Context context) {
        ServiceConnection anonymousClass1 = new AnonymousClass1(this, context);
