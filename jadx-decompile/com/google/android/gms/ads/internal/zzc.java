...
public abstract class zzc extends zzb implements zzg, zzfi {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza) {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        class AnonymousClass1 implements OnTouchListener {
            ...
            AnonymousClass1(AnonymousClass2 anonymousClass2, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = anonymousClass2;
        ...
        class AnonymousClass2 implements OnClickListener {
            ...
            AnonymousClass2(AnonymousClass2 anonymousClass2, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = anonymousClass2;
                this.zzoE = com_google_android_gms_ads_internal_zze;
            }
        ...
        AnonymousClass2(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
            this.zzoC = com_google_android_gms_ads_internal_zzc;
            this.zzoB = com_google_android_gms_internal_zzhs_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new AnonymousClass1(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new AnonymousClass2(this, com_google_android_gms_ads_internal_zze));
    ...
    protected void zza(zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
        if (com_google_android_gms_internal_zzhs_zza.errorCode != -2) {
            zzid.zzIE.post(new AnonymousClass1(this, com_google_android_gms_internal_zzhs_zza));
            return;
        }
        ...
        zzid.zzIE.post(new AnonymousClass2(this, com_google_android_gms_internal_zzhs_zza, com_google_android_gms_internal_zzcg));
    }
