...
public final class Gson {
    ...
    static class AnonymousClass6 extends TypeAdapter<AtomicLong> {
    ...
    static class AnonymousClass7 extends TypeAdapter<AtomicLongArray> {
        final /* synthetic */ TypeAdapter val$longAdapter;

        AnonymousClass7(TypeAdapter typeAdapter) {
            this.val$longAdapter = typeAdapter;
        }
