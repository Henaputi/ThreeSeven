...
public class ImageLoader {
    ...
    class AnonymousClass2 implements Listener<Bitmap> {
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new AnonymousClass1(errorImageResId, view, defaultImageResId);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, String cacheKey) {
        return new ImageRequest(requestUrl, new AnonymousClass2(cacheKey), maxWidth, maxHeight, scaleType, Config.RGB_565, new AnonymousClass3(cacheKey));
    }
