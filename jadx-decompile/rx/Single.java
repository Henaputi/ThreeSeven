...
public class Single<T> {
    ...
    class AnonymousClass19 implements OnSubscribe<T> {
        ...
        class AnonymousClass1 implements Action0 {
            ...
            AnonymousClass1(SingleSubscriber singleSubscriber, Worker worker) {
            ...
            public void call() {
                SingleSubscriber ssub = new SingleSubscriber<T>() {
                    public void onSuccess(T value) {
                        try {
                            AnonymousClass1.this.val$t.onSuccess(value);
                        } finally {
                    ...
                    public void onError(Throwable error) {
                        try {
                            AnonymousClass1.this.val$t.onError(error);
                        } finally {
                            AnonymousClass1.this.val$w.unsubscribe();
                        }
                    }
        ...
        public void call(SingleSubscriber<? super T> t) {
            ...
            t.add(w);
            w.schedule(new AnonymousClass1(t, w));
        }
    }

    /* renamed from: rx.Single.1 */
    class AnonymousClass1 implements rx.Observable.OnSubscribe<T> {
        ...
        AnonymousClass1(OnSubscribe onSubscribe) {
        ...
        public void call(Subscriber<? super T> child) {
            ...
            SingleSubscriber<T> ss = new AnonymousClass1(producer, child);
            child.add(ss);
            this.val$f.call(ss);
        }
    }
    ...
    class AnonymousClass20 implements Operator<T, T> {
        ...
        class AnonymousClass2 implements CompletableSubscriber {
            ...
            AnonymousClass2(Subscriber subscriber, Subscriber subscriber2) {
        ...
        public Subscriber<? super T> call(Subscriber<? super T> child) {
            ...
            CompletableSubscriber so = new AnonymousClass2(main, serial);
            serial.add(main);
            child.add(serial);
    ...
    class AnonymousClass2 implements rx.Observable.OnSubscribe<R> {
        final /* synthetic */ Operator val$lift;

        AnonymousClass2(Operator operator) {
    ...
    static class AnonymousClass5 implements OnSubscribe<T> {
        ...
        class AnonymousClass1 extends SingleSubscriber<Single<? extends T>> {
        ...
        AnonymousClass5(Single single) {
            this.val$source = single;
        }

        public void call(SingleSubscriber<? super T> child) {
            this.val$source.subscribe(new AnonymousClass1(child));
        }
    }

    /* renamed from: rx.Single.6 */
    static class AnonymousClass6 implements FuncN<R> {
        final /* synthetic */ Func2 val$zipFunction;

        AnonymousClass6(Func2 func2) {
    ...
    static class AnonymousClass7 implements FuncN<R> {
        final /* synthetic */ Func3 val$zipFunction;

        AnonymousClass7(Func3 func3) {
    ...
    static class AnonymousClass8 implements FuncN<R> {
        final /* synthetic */ Func4 val$zipFunction;

        AnonymousClass8(Func4 func4) {
    ...
    static class AnonymousClass9 implements FuncN<R> {
        final /* synthetic */ Func5 val$zipFunction;

        AnonymousClass9(Func5 func5) {
    ...
    protected Single(OnSubscribe<T> f) {
        this.onSubscribe = new AnonymousClass1(f);
    }
    ...
    public final <R> Single<R> lift(Operator<? extends R, ? super T> lift) {
        return new Single(new AnonymousClass2(lift));
    }
    ...
    public static <T> Single<T> error(Throwable exception) {
        return create(new AnonymousClass3(exception));
    }
    ...
    public static <T> Single<T> fromCallable(Callable<? extends T> func) {
        return create(new AnonymousClass4(func));
    }
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> source) {
        ...
        return create(new AnonymousClass5(source));
    }
    ...
    public static <T1, T2, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Func2<? super T1, ? super T2, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2}, new AnonymousClass6(zipFunction));
    }
    ...
    public static <T1, T2, T3, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Func3<? super T1, ? super T2, ? super T3, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3}, new AnonymousClass7(zipFunction));
    }
    ...
    public static <T1, T2, T3, T4, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Single<? extends T4> s4, Func4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3, s4}, new AnonymousClass8(zipFunction));
    }
    ...
    public static <T1, T2, T3, T4, T5, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Single<? extends T4> s4, Single<? extends T5> s5, Func5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3, s4, s5}, new AnonymousClass9(zipFunction));
    }
    ...
    public final <E> Single<T> takeUntil(Single<? extends E> other) {
        return lift(new Operator<T, T>() {
            ...
            class AnonymousClass2 extends SingleSubscriber<E> {
                final /* synthetic */ Subscriber val$main;
            ...
            public Subscriber<? super T> call(Subscriber<? super T> child) {
                Subscriber<T> serial = new SerializedSubscriber(child, false);
                Subscriber<T> main = new AnonymousClass1(serial, false, serial);
                SingleSubscriber so = new AnonymousClass2(main);
                serial.add(main);
                serial.add(so);
                child.add(serial);
                this.val$other.subscribe(so);
