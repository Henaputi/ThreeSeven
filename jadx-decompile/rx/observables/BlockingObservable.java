...
public final class BlockingObservable<T> {
    ...
    class AnonymousClass1 extends Subscriber<T> {
        ...
        AnonymousClass1(CountDownLatch countDownLatch, AtomicReference atomicReference, Action1 action1) {
    ...
    class AnonymousClass3 extends Subscriber<T> {
        ...
        AnonymousClass3(CountDownLatch countDownLatch, AtomicReference atomicReference, AtomicReference atomicReference2) {
            this.val$latch = countDownLatch;
    ...
    class AnonymousClass4 extends Subscriber<T> {
        ...
        AnonymousClass4(Throwable[] thArr, CountDownLatch countDownLatch) {
    ...
    class AnonymousClass6 extends Subscriber<T> {
        ...
        AnonymousClass6(BlockingQueue blockingQueue, NotificationLite notificationLite, Producer[] producerArr) {
            this.val$queue = blockingQueue;
            this.val$nl = notificationLite;
    ...
    class AnonymousClass7 implements Action0 {
        ...
        AnonymousClass7(BlockingQueue blockingQueue) {
            this.val$queue = blockingQueue;
        }
    ...
    class AnonymousClass9 implements Observer<T> {
        ...
        AnonymousClass9(Action1 action1, Action1 action12, Action0 action0) {
            this.val$onNext = action1;
    ...
    public void forEach(Action1<? super T> onNext) {
        ...
        BlockingUtils.awaitForComplete(latch, this.o.subscribe(new AnonymousClass1(latch, exceptionFromOnError, onNext)));
    ...
    private T blockForSingle(Observable<? extends T> observable) {
        ...
        CountDownLatch latch = new CountDownLatch(1);
        BlockingUtils.awaitForComplete(latch, observable.subscribe(new AnonymousClass3(latch, returnException, returnItem)));
    ...
    public void subscribe() {
        ...
        BlockingUtils.awaitForComplete(cdl, this.o.subscribe(new AnonymousClass4(error, cdl)));
        Throwable e = error[0];
        if (e == null) {
            return;
        }
    ...
    public void subscribe(Observer<? super T> observer) {
        ...
        Subscription s = this.o.subscribe(new AnonymousClass5(queue, nl));
        while (true) {
            try {
                Object o = queue.poll();
                if (o == null) {
    ...
    public void subscribe(Action1<? super T> onNext, Action1<? super Throwable> onError, Action0 onCompleted) {
        subscribe(new AnonymousClass9(onNext, onError, onCompleted));
    }
}
