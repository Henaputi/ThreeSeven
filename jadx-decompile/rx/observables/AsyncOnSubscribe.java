...
public abstract class AsyncOnSubscribe<S, T> implements OnSubscribe<T> {
    ...
    static class AnonymousClass2 implements Func3<S, Long, Observer<Observable<? extends T>>, S> {
        ...
        AnonymousClass2(Action3 action3) {
            this.val$next = action3;
        }
    ...
    static class AnonymousClass3 implements Func3<Void, Long, Observer<Observable<? extends T>>, Void> {
        ...
        AnonymousClass3(Action2 action2) {
    ...
    static class AnonymousClass4 implements Func3<Void, Long, Observer<Observable<? extends T>>, Void> {
        ...
        AnonymousClass4(Action2 action2) {
            this.val$next = action2;
        }
    ...
    static class AnonymousClass5 implements Action1<Void> {
        ...
        AnonymousClass5(Action0 action0) {
    ...
    class AnonymousClass6 extends Subscriber<T> {
        ...
        AnonymousClass6(Subscriber subscriber, AsyncOuterManager asyncOuterManager) {
    ...
    static final class AsyncOuterManager<S, T> implements Producer, Subscription, Observer<Observable<? extends T>> {
        ...
        private void subscribeBufferToObservable(Observable<? extends T> t) {
            ...
            Subscriber s = new AnonymousClass1(this.expectedDelivery, buffer);
            this.subscriptions.add(s);
            t.doOnTerminate(new AnonymousClass2(s)).subscribe(s);
    ...
    public static <S, T> AsyncOnSubscribe<S, T> createSingleState(Func0<? extends S> generator, Action3<? super S, Long, ? super Observer<Observable<? extends T>>> next) {
        return new AsyncOnSubscribeImpl((Func0) generator, new AnonymousClass1(next));
    }
    ...
    public static <S, T> AsyncOnSubscribe<S, T> createSingleState(Func0<? extends S> generator, Action3<? super S, Long, ? super Observer<Observable<? extends T>>> next, Action1<? super S> onUnsubscribe) {
        return new AsyncOnSubscribeImpl(generator, new AnonymousClass2(next), onUnsubscribe);
    }
    ...
    public static <T> AsyncOnSubscribe<Void, T> createStateless(Action2<Long, ? super Observer<Observable<? extends T>>> next) {
        return new AsyncOnSubscribeImpl(new AnonymousClass3(next));
    }
    ...
    public static <T> AsyncOnSubscribe<Void, T> createStateless(Action2<Long, ? super Observer<Observable<? extends T>>> next, Action0 onUnsubscribe) {
        return new AsyncOnSubscribeImpl(new AnonymousClass4(next), new AnonymousClass5(onUnsubscribe));
    }
    ...
    public final void call(Subscriber<? super T> actualSubscriber) {
        try {
            ...
            Subscriber<T> concatSubscriber = new AnonymousClass6(actualSubscriber, outerProducer);
