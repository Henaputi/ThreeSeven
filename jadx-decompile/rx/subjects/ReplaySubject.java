...
public final class ReplaySubject<T> extends Subject<T, T> {
    ...
    static class AnonymousClass2 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;
    ...
    static class AnonymousClass3 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;
    ...
    static class AnonymousClass4 implements Action1<SubjectObserver<T>> {
    ...
    static class AnonymousClass5 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ BoundedState val$state;
    ...
    public static <T> ReplaySubject<T> create(int capacity) {
        ...
        ssm.onStart = new AnonymousClass1(state);
        ssm.onAdded = new AnonymousClass2(state);
        ssm.onTerminated = new AnonymousClass3(state);
    ...
    static <T> ReplaySubject<T> createWithState(BoundedState<T> state, Action1<SubjectObserver<T>> onStart) {
        SubjectSubscriptionManager<T> ssm = new SubjectSubscriptionManager();
        ssm.onStart = onStart;
        ssm.onAdded = new AnonymousClass4(state);
        ssm.onTerminated = new AnonymousClass5(state);
        return new ReplaySubject(ssm, ssm, state);
    }
