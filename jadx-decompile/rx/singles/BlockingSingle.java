...
public class BlockingSingle<T> {
    ...
    class AnonymousClass1 extends SingleSubscriber<T> {
        ...
        AnonymousClass1(AtomicReference atomicReference, CountDownLatch countDownLatch, AtomicReference atomicReference2) {
    ...
    public T value() {
        ...
        BlockingUtils.awaitForComplete(latch, this.single.subscribe(new AnonymousClass1(returnItem, latch, returnException)));
