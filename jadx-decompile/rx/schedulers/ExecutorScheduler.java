...
final class ExecutorScheduler extends Scheduler {
    ...
    static final class ExecutorSchedulerWorker extends Worker implements Runnable {
        ...
        class AnonymousClass1 implements Action0 {
            ...
            AnonymousClass1(MultipleAssignmentSubscription multipleAssignmentSubscription) {
        ...
        class AnonymousClass2 implements Action0 {
            ...
            AnonymousClass2(MultipleAssignmentSubscription multipleAssignmentSubscription, Action0 action0, Subscription subscription) {
                this.val$mas = multipleAssignmentSubscription;
        ...
        public Subscription schedule(Action0 action, long delayTime, TimeUnit unit) {
            ...
            mas.set(first);
            this.tasks.add(mas);
            Subscription removeMas = Subscriptions.create(new AnonymousClass1(mas));
            ScheduledAction ea = new ScheduledAction(new AnonymousClass2(mas, action, removeMas));
            first.set(ea);
            try {
