...
public final class OperatorSampleWithObservable<T, U> implements Operator<T, T> {
    ...
    class AnonymousClass1 extends Subscriber<U> {
        ...
        AnonymousClass1(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber, AtomicReference atomicReference2) {
    ...
    class AnonymousClass2 extends Subscriber<T> {
        ...
        AnonymousClass2(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber, Subscriber subscriber) {
            this.val$value = atomicReference;
            this.val$s = serializedSubscriber;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        Subscriber<U> samplerSub = new AnonymousClass1(value, s, main);
        Subscriber<T> result = new AnonymousClass2(value, s, samplerSub);
        main.lazySet(result);
        child.add(result);
