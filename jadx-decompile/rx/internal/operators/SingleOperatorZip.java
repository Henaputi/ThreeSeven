...
public class SingleOperatorZip {
    ...
    static class AnonymousClass1 implements OnSubscribe<R> {
        ...
        class AnonymousClass1 extends SingleSubscriber<T> {
            ...
            AnonymousClass1(Object[] objArr, int i, AtomicInteger atomicInteger, SingleSubscriber singleSubscriber, AtomicBoolean atomicBoolean) {
            ...
            public void onSuccess(T value) {
                ...
                if (this.val$wip.decrementAndGet() == 0) {
                    try {
                        this.val$subscriber.onSuccess(AnonymousClass1.this.val$zipper.call(this.val$values));
                    } catch (Throwable e) {
        ...
        AnonymousClass1(Single[] singleArr, FuncN funcN) {
        ...
        public void call(SingleSubscriber<? super R> subscriber) {
            ...
            while (i < this.val$singles.length && !compositeSubscription.isUnsubscribed() && !once.get()) {
                SingleSubscriber singleSubscriber = new AnonymousClass1(values, i, wip, subscriber, once);
    ...
    public static <T, R> Single<R> zip(Single<? extends T>[] singles, FuncN<? extends R> zipper) {
        return Single.create(new AnonymousClass1(singles, zipper));
    }
}
