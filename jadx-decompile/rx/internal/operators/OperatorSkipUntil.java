...
public final class OperatorSkipUntil<T, U> implements Operator<T, T> {
    ...
    class AnonymousClass1 extends Subscriber<U> {
        ...
        AnonymousClass1(AtomicBoolean atomicBoolean, SerializedSubscriber serializedSubscriber) {
    ...
    class AnonymousClass2 extends Subscriber<T> {
        ...
        AnonymousClass2(Subscriber x0, AtomicBoolean atomicBoolean, SerializedSubscriber serializedSubscriber) {
            this.val$gate = atomicBoolean;
            this.val$s = serializedSubscriber;
            super(x0);
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        Subscriber<U> u = new AnonymousClass1(gate, s);
        child.add(u);
        this.other.unsafeSubscribe(u);
        return new AnonymousClass2(child, gate, s);
    }
}
