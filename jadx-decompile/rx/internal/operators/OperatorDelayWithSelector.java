...
public final class OperatorDelayWithSelector<T, V> implements Operator<T, T> {
    ...
    class AnonymousClass1 extends Subscriber<T> {
        ...
        class AnonymousClass1 implements Func1<V, T> {
        ...
        AnonymousClass1(Subscriber x0, PublishSubject publishSubject, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            try {
                this.val$delayedEmissions.onNext(((Observable) OperatorDelayWithSelector.this.itemDelay.call(t)).take(1).defaultIfEmpty(null).map(new AnonymousClass1(t)));
            } catch (Throwable e) {
    ...
    public Subscriber<? super T> call(Subscriber<? super T> _child) {
        ...
        return new AnonymousClass1(_child, delayedEmissions, child);
    }
}
