...
public final class OperatorWindowWithStartEndObservable<T, U, V> implements Operator<Observable<T>, T> {
    ...
    class AnonymousClass1 extends Subscriber<U> {
        ...
        AnonymousClass1(SourceSubscriber sourceSubscriber) {
    ...
    final class SourceSubscriber extends Subscriber<T> {
        ...
        class AnonymousClass1 extends Subscriber<V> {
            ...
            AnonymousClass1(SerializedSubject serializedSubject) {
        ...
        void beginWindow(U token) {
            ...
            synchronized (this.guard) {
                ...
                try {
                    ...
                    Subscriber<V> v = new AnonymousClass1(s);
                    this.csub.add(v);
    ...
    public Subscriber<? super T> call(Subscriber<? super Observable<T>> child) {
        ...
        Subscriber<U> open = new AnonymousClass1(sub);
        csub.add(sub);
        csub.add(open);
