...
public final class BlockingOperatorToFuture {
    ...
    static class AnonymousClass1 extends Subscriber<T> {
        ...
        AnonymousClass1(CountDownLatch countDownLatch, AtomicReference atomicReference, AtomicReference atomicReference2) {
    ...
    static class AnonymousClass2 implements Future<T> {
        ...
        AnonymousClass2(CountDownLatch countDownLatch, Subscription subscription, AtomicReference atomicReference, AtomicReference atomicReference2) {
            this.val$finished = countDownLatch;
    ...
    public static <T> Future<T> toFuture(Observable<? extends T> that) {
        ...
        return new AnonymousClass2(finished, that.single().subscribe(new AnonymousClass1(finished, error, value)), error, value);
    }
}
