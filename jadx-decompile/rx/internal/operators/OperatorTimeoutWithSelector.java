...
public class OperatorTimeoutWithSelector<T, U, V> extends OperatorTimeoutBase<T> {
    ...
    class AnonymousClass1 implements FirstTimeoutStub<T> {
        ...
        public Subscription call(TimeoutSubscriber<T> timeoutSubscriber, Long seqId, Worker inner) {
            ...
            try {
                return ((Observable) this.val$firstTimeoutSelector.call()).unsafeSubscribe(new AnonymousClass1(timeoutSubscriber, seqId));
            } catch (Throwable t) {
    ...
    class AnonymousClass2 implements TimeoutStub<T> {
        ...
        class AnonymousClass1 extends Subscriber<V> {
            final /* synthetic */ Long val$seqId;
            final /* synthetic */ TimeoutSubscriber val$timeoutSubscriber;
        ...
        public Subscription call(TimeoutSubscriber<T> timeoutSubscriber, Long seqId, T value, Worker inner) {
            try {
                return ((Observable) this.val$timeoutSelector.call(value)).unsafeSubscribe(new AnonymousClass1(timeoutSubscriber, seqId));
            } catch (Throwable t) {
                Exceptions.throwOrReport(t, (Observer) timeoutSubscriber);
                return Subscriptions.unsubscribed();
            }
