...
public final class OperatorZipIterable<T1, T2, R> implements Operator<R, T1> {
    ...
    class AnonymousClass1 extends Subscriber<T1> {
        boolean done;
        final /* synthetic */ Iterator val$iterator;
        final /* synthetic */ Subscriber val$subscriber;

        AnonymousClass1(Subscriber x0, Subscriber subscriber, Iterator it) {
    ...
    public Subscriber<? super T1> call(Subscriber<? super R> subscriber) {
        ...
        try {
            if (iterator.hasNext()) {
                return new AnonymousClass1(subscriber, subscriber, iterator);
            }
