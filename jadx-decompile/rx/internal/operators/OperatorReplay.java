...
public final class OperatorReplay<T> extends ConnectableObservable<T> {
    ...
    static class AnonymousClass2 implements OnSubscribe<R> {
        ...
        AnonymousClass2(Func0 func0, Func1 func1) {
        ...
        public void call(Subscriber<? super R> child) {
            try {
                ...
                co.connect(new AnonymousClass1(child));
            } catch (Throwable e) {
    ...
    static class AnonymousClass3 implements OnSubscribe<T> {
        ...
        public void call(Subscriber<? super T> child) {
            this.val$observable.unsafeSubscribe(new AnonymousClass1(child, child));
        }
    }
    ...
    static class AnonymousClass4 extends ConnectableObservable<T> {
        ...
        AnonymousClass4(OnSubscribe x0, ConnectableObservable connectableObservable) {
    ...
    static class AnonymousClass5 implements Func0<ReplayBuffer<T>> {
    ...
    static class AnonymousClass6 implements Func0<ReplayBuffer<T>> {
        final /* synthetic */ int val$bufferSize;
        final /* synthetic */ long val$maxAgeInMillis;
        final /* synthetic */ Scheduler val$scheduler;

        AnonymousClass6(int i, long j, Scheduler scheduler) {
            this.val$bufferSize = i;
    ...
    static class AnonymousClass7 implements OnSubscribe<T> {
        final /* synthetic */ Func0 val$bufferFactory;
        final /* synthetic */ AtomicReference val$curr;

        AnonymousClass7(AtomicReference atomicReference, Func0 func0) {
    ...
    public static <T, U, R> Observable<R> multicastSelector(Func0<? extends ConnectableObservable<U>> connectableFactory, Func1<? super Observable<U>, ? extends Observable<R>> selector) {
        return Observable.create(new AnonymousClass2(connectableFactory, selector));
    }

    public static <T> ConnectableObservable<T> observeOn(ConnectableObservable<T> co, Scheduler scheduler) {
        return new AnonymousClass4(new AnonymousClass3(co.observeOn(scheduler)), co);
    }
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> source, int bufferSize) {
        ...
        return create((Observable) source, new AnonymousClass5(bufferSize));
    }
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> source, long maxAge, TimeUnit unit, Scheduler scheduler, int bufferSize) {
        return create((Observable) source, new AnonymousClass6(bufferSize, unit.toMillis(maxAge), scheduler));
    }
    ...
    static <T> ConnectableObservable<T> create(Observable<? extends T> source, Func0<? extends ReplayBuffer<T>> bufferFactory) {
        ...
        return new OperatorReplay(new AnonymousClass7(curr, bufferFactory), source, curr, bufferFactory);
    }
