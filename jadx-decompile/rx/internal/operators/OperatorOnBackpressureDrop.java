...
public class OperatorOnBackpressureDrop<T> implements Operator<T, T> {
    ...
    class AnonymousClass2 extends Subscriber<T> {
        ...
        AnonymousClass2(Subscriber x0, Subscriber subscriber, AtomicLong atomicLong) {
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        child.setProducer(new AnonymousClass1(requested));
        return new AnonymousClass2(child, child, requested);
    }
}
