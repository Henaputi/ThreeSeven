...
public final class OperatorBufferWithStartEndObservable<T, TOpening, TClosing> implements Operator<List<T>, T> {
    ...
    class AnonymousClass1 extends Subscriber<TOpening> {
        final /* synthetic */ BufferingSubscriber val$bsub;

        AnonymousClass1(BufferingSubscriber bufferingSubscriber) {
    ...
    final class BufferingSubscriber extends Subscriber<T> {
        ...
        class AnonymousClass1 extends Subscriber<TClosing> {
        ...
        void startBuffer(TOpening v) {
            ...
            synchronized (this) {
                ...
                try {
                    ...
                    Subscriber<TClosing> closeSubscriber = new AnonymousClass1(chunk);
    ...
    public Subscriber<? super T> call(Subscriber<? super List<T>> child) {
        ...
        Subscriber<TOpening> openSubscriber = new AnonymousClass1(bsub);
