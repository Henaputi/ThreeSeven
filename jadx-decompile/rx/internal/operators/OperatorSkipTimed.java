...
public final class OperatorSkipTimed<T> implements Operator<T, T> {
    ...
    class AnonymousClass2 extends Subscriber<T> {
        ...
        AnonymousClass2(Subscriber x0, AtomicBoolean atomicBoolean, Subscriber subscriber) {
            this.val$gate = atomicBoolean;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        worker.schedule(new AnonymousClass1(gate), this.time, this.unit);
        return new AnonymousClass2(child, gate, child);
    }
}
