...
public final class OperatorWithLatestFrom<T, U, R> implements Operator<R, T> {
    ...
    class AnonymousClass1 extends Subscriber<T> {
        ...
        AnonymousClass1(Subscriber x0, boolean x1, AtomicReference atomicReference, SerializedSubscriber serializedSubscriber) {
    ...
    class AnonymousClass2 extends Subscriber<U> {
        final /* synthetic */ AtomicReference val$current;
        final /* synthetic */ SerializedSubscriber val$s;

        AnonymousClass2(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber) {
            this.val$current = atomicReference;
            this.val$s = serializedSubscriber;
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super R> child) {
        ...
        Subscriber<T> subscriber = new AnonymousClass1(s, true, current, s);
        Subscriber<U> otherSubscriber = new AnonymousClass2(current, s);
        s.add(subscriber);
