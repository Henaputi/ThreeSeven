...
public final class OnSubscribeAmb<T> implements OnSubscribe<T> {
    ...
    class AnonymousClass1 implements Action0 {
        ...
        AnonymousClass1(AtomicReference atomicReference, Selection selection) {
    ...
    class AnonymousClass2 implements Producer {
        ...
        AnonymousClass2(AtomicReference atomicReference, Selection selection) {
            this.val$choice = atomicReference;
            this.val$selection = selection;
        }
    ...
    public void call(Subscriber<? super T> subscriber) {
        ...
        subscriber.add(Subscriptions.create(new AnonymousClass1(choice, selection)));
        ...
        subscriber.setProducer(new AnonymousClass2(choice, selection));
    }
