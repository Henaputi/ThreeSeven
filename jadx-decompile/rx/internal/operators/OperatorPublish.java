...
public final class OperatorPublish<T> extends ConnectableObservable<T> {
    ...
    static class AnonymousClass2 implements OnSubscribe<R> {
        ...
        class AnonymousClass1 extends Subscriber<R> {
            final /* synthetic */ Subscriber val$child;
            final /* synthetic */ OnSubscribePublishMulticast val$op;

            AnonymousClass1(Subscriber subscriber, OnSubscribePublishMulticast onSubscribePublishMulticast) {
        ...
        AnonymousClass2(boolean z, Func1 func1, Observable observable) {
        ...
        public void call(Subscriber<? super R> child) {
            ...
            Subscriber<R> subscriber = new AnonymousClass1(child, op);
            child.add(op);
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> source) {
        ...
        return new OperatorPublish(new AnonymousClass1(curr), source, curr);
    }
    ...
    public static <T, R> Observable<R> create(Observable<? extends T> source, Func1<? super Observable<T>, ? extends Observable<R>> selector, boolean delayError) {
        return Observable.create(new AnonymousClass2(delayError, selector, source));
    }
