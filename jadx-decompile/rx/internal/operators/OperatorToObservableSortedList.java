...
public final class OperatorToObservableSortedList<T> implements Operator<List<T>, T> {
    ...
    class AnonymousClass2 extends Subscriber<T> {
        ...
        AnonymousClass2(SingleDelayedProducer singleDelayedProducer, Subscriber subscriber) {
    ...
    public OperatorToObservableSortedList(Func2<? super T, ? super T, Integer> sortFunction, int initialCapacity) {
        this.initialCapacity = initialCapacity;
        this.sortFunction = new AnonymousClass1(sortFunction);
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super List<T>> child) {
        ...
        Subscriber<T> result = new AnonymousClass2(producer, child);
        child.add(result);
