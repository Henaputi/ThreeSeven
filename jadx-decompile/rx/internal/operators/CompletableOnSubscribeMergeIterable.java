...
public final class CompletableOnSubscribeMergeIterable implements CompletableOnSubscribe {
    ...
    class AnonymousClass1 implements CompletableSubscriber {
        ...
        AnonymousClass1(CompositeSubscription compositeSubscription, AtomicBoolean atomicBoolean, CompletableSubscriber completableSubscriber, AtomicInteger atomicInteger) {
                        ...
                        if (!set.isUnsubscribed()) {
                            try {
                                ...
                                if (!set.isUnsubscribed()) {
                                    ...
                                    wip.getAndIncrement();
                                    c.subscribe(new AnonymousClass1(set, once, s, wip));
                                } else {
                                    return;
                                }
                            } catch (Throwable e) {
