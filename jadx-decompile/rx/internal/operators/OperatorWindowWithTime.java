...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class AnonymousClass1 implements Action0 {
            ...
            AnonymousClass1(OperatorWindowWithTime operatorWindowWithTime) {
        ...
        public ExactSubscriber(Subscriber<? super Observable<T>> child, Worker worker) {
            ...
            child.add(Subscriptions.create(new AnonymousClass1(OperatorWindowWithTime.this)));
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class AnonymousClass2 implements Action0 {
            ...
            AnonymousClass2(CountedSerializedSubject countedSerializedSubject) {
        ...
        void startNewChunk() {
            ...
            synchronized (this.guard) {
                ...
                try {
                    ...
                    this.worker.schedule(new AnonymousClass2(chunk), OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
                } catch (Throwable e) {
                    onError(e);
                }
            }
