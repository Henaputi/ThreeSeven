...
public final class OperatorDebounceWithTime<T> implements Operator<T, T> {
    ...
    class AnonymousClass1 extends Subscriber<T> {
        ...
        AnonymousClass1(Subscriber x0, SerialSubscription serialSubscription, Worker worker, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            this.val$ssub.set(this.val$worker.schedule(new AnonymousClass1(this.state.next(t)), OperatorDebounceWithTime.this.timeout, OperatorDebounceWithTime.this.unit));
        }
