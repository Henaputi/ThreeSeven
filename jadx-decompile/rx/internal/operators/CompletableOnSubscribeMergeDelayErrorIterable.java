...
public final class CompletableOnSubscribeMergeDelayErrorIterable implements CompletableOnSubscribe {
    ...
    class AnonymousClass1 implements CompletableSubscriber {
        ...
        AnonymousClass1(CompositeSubscription compositeSubscription, Queue queue, AtomicInteger atomicInteger, CompletableSubscriber completableSubscriber) {
                        ...
                        if (!set.isUnsubscribed()) {
                            try {
                                ...
                                if (!set.isUnsubscribed()) {
                                    ...
                                    wip.getAndIncrement();
                                    c.subscribe(new AnonymousClass1(set, queue, wip, s));
                                } else {
                                    return;
                                }
