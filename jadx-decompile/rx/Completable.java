...
public class Completable {
    ...
    static class AnonymousClass10 implements CompletableOnSubscribe {
        ...
        public void call(CompletableSubscriber cs) {
            Subscriber<Object> subscriber = new AnonymousClass1(cs);
    ...
    static class AnonymousClass11 implements CompletableOnSubscribe {
        ...
        class AnonymousClass1 extends SingleSubscriber<Object> {
        ...
        public void call(CompletableSubscriber s) {
            SingleSubscriber te = new AnonymousClass1(s);
            s.onSubscribe(te);
    ...
    static class AnonymousClass12 implements CompletableOnSubscribe {
        ...
        class AnonymousClass1 implements Action0 {
            ...
            AnonymousClass1(CompletableSubscriber completableSubscriber, Worker worker) {
                this.val$s = completableSubscriber;
                this.val$w = worker;
            }
        ...
        public void call(CompletableSubscriber s) {
            ...
            if (!mad.isUnsubscribed()) {
                ...
                mad.set(w);
                w.schedule(new AnonymousClass1(s, w), this.val$delay, this.val$unit);
            }
        }
    }
    ...
    static class AnonymousClass13 implements CompletableOnSubscribe {
        ...
        class AnonymousClass1 implements CompletableSubscriber {
            ...
            public void onSubscribe(Subscription d) {
                this.d = d;
                this.val$s.onSubscribe(Subscriptions.create(new Action0() {
                    public void call() {
        ...
        public void call(CompletableSubscriber s) {
            try {
                ...
                try {
                    ...
                    cs.subscribe(new AnonymousClass1(new AtomicBoolean(), resource, s));
                } catch (Throwable ex2) {
    ...
    class AnonymousClass16 implements CompletableOnSubscribe {
        ...
        class AnonymousClass1 implements CompletableSubscriber {
            ...
            class AnonymousClass2 implements Action0 {
                ...
                public void call() {
                    try {
                        AnonymousClass1.this.val$s.onError(this.val$e);
                    } finally {
                        AnonymousClass1.this.val$w.unsubscribe();
                    }
                }
            }

            AnonymousClass1(CompositeSubscription compositeSubscription, Worker worker, CompletableSubscriber completableSubscriber) {
            ...
            public void onError(Throwable e) {
                if (AnonymousClass16.this.val$delayError) {
                    this.val$set.add(this.val$w.schedule(new AnonymousClass2(e), AnonymousClass16.this.val$delay, AnonymousClass16.this.val$unit));
                } else {
                    this.val$s.onError(e);
                }
            }
        ...
        public void call(CompletableSubscriber s) {
            ...
            Worker w = this.val$scheduler.createWorker();
            set.add(w);
            Completable.this.subscribe(new AnonymousClass1(set, w, s));
        }
    }
    ...
    class AnonymousClass17 implements CompletableOnSubscribe {
        ...
        class AnonymousClass1 implements CompletableSubscriber {
            ...
            public void onSubscribe(Subscription d) {
                try {
                    ...
                    this.val$s.onSubscribe(Subscriptions.create(new AnonymousClass1(d)));
                } catch (Throwable ex) {
                    d.unsubscribe();
        ...
        public void call(CompletableSubscriber s) {
            Completable.this.subscribe(new AnonymousClass1(s));
        }
    }
    ...
    class AnonymousClass22 implements CompletableOnSubscribe {
        ...
        class AnonymousClass1 implements CompletableSubscriber {
            ...
            class AnonymousClass2 implements Action0 {
                ...
                public void call() {
                    try {
                        ...
                        AnonymousClass1.this.val$ad.unsubscribe();
                    }
                }
            }

            AnonymousClass1(Worker worker, CompletableSubscriber completableSubscriber, SubscriptionList subscriptionList) {
                this.val$w = worker;
                this.val$s = completableSubscriber;
            ...
            public void onError(Throwable e) {
                this.val$w.schedule(new AnonymousClass2(e));
            }
        ...
        public void call(CompletableSubscriber s) {
            ...
            ad.add(w);
            s.onSubscribe(ad);
            Completable.this.subscribe(new AnonymousClass1(w, s, ad));
        }
    }
    ...
    class AnonymousClass24 implements CompletableOnSubscribe {
            ...
            public void onError(Throwable e) {
                ...
                try {
                    ...
                    c.subscribe(new CompletableSubscriber() {
                        ...
                        public void onSubscribe(Subscription d) {
                            AnonymousClass1.this.val$sd.set(d);
                        }
                    });
                } catch (Throwable ex) {
        ...
        public void call(CompletableSubscriber s) {
            Completable.this.subscribe(new AnonymousClass1(s, new SerialSubscription()));
        }
    }
    ...
    class AnonymousClass29 implements CompletableOnSubscribe {
        ...
        public void call(CompletableSubscriber s) {
            Worker w = this.val$scheduler.createWorker();
            w.schedule(new AnonymousClass1(s, w));
        }
    }
        ...
        class AnonymousClass1 implements CompletableSubscriber {
            ...
            class AnonymousClass1 implements Action0 {
                ...
                class AnonymousClass1 implements Action0 {
                    ...
                    public void call() {
                        try {
                            AnonymousClass1.this.val$d.unsubscribe();
                        } finally {
                            this.val$w.unsubscribe();
                        }
                    }
                ...
                public void call() {
                    ...
                    w.schedule(new AnonymousClass1(w));
                }
            }
    ...
    static class AnonymousClass3 implements CompletableOnSubscribe {
        ...
        public void call(CompletableSubscriber s) {
            ...
            CompletableSubscriber inner = new AnonymousClass1(once, set, s);
    ...
    static class AnonymousClass8 implements CompletableOnSubscribe {
        ...
        AnonymousClass8(Action0 action0) {
    ...
    static {
        COMPLETE = create(new CompletableOnSubscribe() {
            public void call(CompletableSubscriber s) {
                s.onSubscribe(Subscriptions.unsubscribed());
                s.onCompleted();
            }
        });
        NEVER = create(new CompletableOnSubscribe() {
            public void call(CompletableSubscriber s) {
                s.onSubscribe(Subscriptions.unsubscribed());
            }
        });
    ...
    public static Completable amb(Completable... sources) {
        ...
        return create(new AnonymousClass3(sources));
    }

    public static Completable amb(Iterable<? extends Completable> sources) {
        requireNonNull(sources);
        return create(new AnonymousClass4(sources));
    }
    ...
    public static Completable defer(Func0<? extends Completable> completableFunc0) {
        ...
        return create(new AnonymousClass5(completableFunc0));
    }

    public static Completable error(Func0<? extends Throwable> errorFunc0) {
        requireNonNull(errorFunc0);
        return create(new AnonymousClass6(errorFunc0));
    }

    public static Completable error(Throwable error) {
        requireNonNull(error);
        return create(new AnonymousClass7(error));
    }

    public static Completable fromAction(Action0 action) {
        requireNonNull(action);
        return create(new AnonymousClass8(action));
    }

    public static Completable fromCallable(Callable<?> callable) {
        requireNonNull(callable);
        return create(new AnonymousClass9(callable));
    }
