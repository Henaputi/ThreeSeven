...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    class AnonymousClass5 extends AnimateOnHWLayerIfNeededListener {
        ...
        AnonymousClass5(View x0, Animation x1, Fragment fragment) {
    ...
    public void popBackStack(String name, int flags) {
        enqueueAction(new AnonymousClass3(name, flags), HONEYCOMB);
    }
    ...
    public void popBackStack(int id, int flags) {
        ...
        enqueueAction(new AnonymousClass4(id, flags), HONEYCOMB);
    }
